...
func (client *FleetsClient) listVirtualMachineScaleSetsCreateRequest(ctx context.Context, resourceGroupName string, name string, options *FleetsClientListVirtualMachineScaleSetsOptions) (*policy.Request, error) {
