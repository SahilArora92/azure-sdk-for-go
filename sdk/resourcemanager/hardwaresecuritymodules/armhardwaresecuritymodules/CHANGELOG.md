...
- New function `NewCloudHsmClustersBackupStatusClient(string, string, azcore.TokenCredential, *arm.ClientOptions) (*CloudHsmClustersBackupStatusClient, error)`
- New function `*CloudHsmClustersBackupStatusClient.Get(context.Context, string, string, *CloudHsmClustersBackupStatusClientGetOptions) (CloudHsmClustersBackupStatusClientGetResponse, error)`
...
- New function `NewCloudHsmClustersRestoreStatusClient(string, string, azcore.TokenCredential, *arm.ClientOptions) (*CloudHsmClustersRestoreStatusClient, error)`
- New function `*CloudHsmClustersRestoreStatusClient.Get(context.Context, string, string, *CloudHsmClustersRestoreStatusClientGetOptions) (CloudHsmClustersRestoreStatusClientGetResponse, error)`
...
- New struct `BackupRestoreBaseResponse`
