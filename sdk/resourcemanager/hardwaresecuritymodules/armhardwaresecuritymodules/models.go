...
// BackupResponse - Backup operation Result
...
// BackupRestoreBaseResponse - Backup and Restore operation common properties
type BackupRestoreBaseResponse struct {
	// Error encountered, if any, during the backup/restore operation.
	Error *ErrorDetail
...
// RestoreResponse - Restore operation properties
