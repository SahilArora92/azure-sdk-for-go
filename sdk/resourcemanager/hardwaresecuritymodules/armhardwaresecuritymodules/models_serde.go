...
// MarshalJSON implements the json.Marshaller interface for type BackupRestoreBaseResponse.
func (b BackupRestoreBaseResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateDateTimeRFC3339(objectMap, "endTime", b.EndTime)
	populate(objectMap, "error", b.Error)
	populate(objectMap, "jobId", b.JobID)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type BackupRestoreBaseResponse.
func (b *BackupRestoreBaseResponse) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", b, err)
	}
